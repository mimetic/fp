 ...
 * - puts caption separator
 * - Changes size in relation to screen to better fit a caption
 
 WHAT I SHOULD DO:
 - Get caption from child <class=caption>
 - Get image block from child, <class="picture"> or something like that
...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		options:	['auto_scroll', 'auto_resize', 'download_link', 'show_info', 'show_extended_info', 'ie6_support', 'ie6_upgrade', 'colorBlend', 'baseurl', 'files', 'text', 'show_linkback', 'keys', 'opacity', 'padding', 'speed', 'rel', 'auto_relify', 'caption_separator', 'show_caption'],
		...
		domReady: function ( )
		{
			...
			*/
			...
			$('body').append('<div id="lightbox-overlay"><div id="lightbox-overlay-text">'+(this.show_linkback ? '<p><span id="lightbox-overlay-text-about"><a href="#" title="'+this.text.about.title+'">'+this.text.about.text+'</a></span></p><p>&nbsp;</p>':'')+'<p><span id="lightbox-overlay-text-close">'+this.text.help.close+'</span><br/>&nbsp;<span id="lightbox-overlay-text-interact">'+this.text.help.interact+'</span></p></div></div><div id="lightbox"><div id="lightbox-imageBox"><div id="lightbox-imageContainer"><img id="lightbox-image" /><div id="lightbox-nav"><a href="#" id="lightbox-nav-btnPrev"></a><a href="#" id="lightbox-nav-btnNext"></a></div><div id="lightbox-loading"><a href="#" id="lightbox-loading-link"><img src="' + this.files.images.loading + '" /></a></div></div></div><div id="lightbox-infoBox"><div id="lightbox-infoContainer"><div id="lightbox-infoHeader"><span id="lightbox-caption">'+(this.download_link ? '<a href="#" title="' + this.text.download + '" id="lightbox-caption-title"></a>' : '')+'<span id="lightbox-caption-separator"></span><span id="lightbox-caption-description"></span></span></div><div id="lightbox-infoFooter"><span id="lightbox-currentNumber"></span><span id="lightbox-close"><a href="#" id="lightbox-close-button" title="'+this.text.closeInfo+'">' + this.text.close + '</a></span></div><div id="lightbox-infoContainer-clear"></div></div></div></div>');
		...
		{	// Resize the boxes
			...
			{	// We want to auto resize
				// *** (DG)
				//var screenRatio = 4/5;
				// This value works better when there's a caption (DG)
				var screenRatio = 7/10;
				
				var maxWidth  = Math.floor(wWidth*screenRatio);
				var maxHeight = Math.floor(wHeight*screenRatio);
				var resizeRatio;
			...
			switch ( step )
			{
				...
				case 4:
					...
					case '1' :
						...
						// The footer never shows this way, since as soon as you
						// move the mouse of the image, the infobox goes away before
						// you can pass over it to show the footer
						$('#lightbox-imageBox').unbind('mouseout').mouseout(function(){
							$('#lightbox-infoBox').slideUp('fast');
							$('#lightbox-infoFooter').slideUp('fast');
						});
