...
if (isset($_POST['twg_user']) && isset($_POST['twg_pass']) && isset($_SESSION['userSessionValue'])) { // twg_user and twg_pass are always sent by the flash! - never remove this part! otherwise everyone can call tfu_config directly
    /**
     * ----------------------------
     * Important!
     * ----------
