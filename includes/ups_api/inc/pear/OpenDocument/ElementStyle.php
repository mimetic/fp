...
class OpenDocument_ElementStyle extends OpenDocument_Style {
	 ...
	 *
	 */
	const FONT_WEIGHT_BOLD = 'bold', FONT_WEIGHT_NORMAL = 'normal', FONT_STYLE_ITALIC = 'italic', FONT_STYLE_NORMAL = 'normal', UNDERLINE_STYLE_SOLID = 'solid';
	
	/**
	 * List of properties
	 *
	 */
	protected $fontWeight, $fontStyle, $fontName, $fontSize, $backgroundColor, $color, $lineHeight, $underlineStyle, $underlineWidth, $underlineColor;
